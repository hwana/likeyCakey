package com.likeycakey.cake.admin.model.vo;
	...
	public class AdminMember implements java.io.Serializable {
		...
		public AdminMember(String id, String passwd, String name, int code, String email, String post, String addressBasic,
