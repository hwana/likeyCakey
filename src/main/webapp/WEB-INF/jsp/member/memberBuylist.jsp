...
<script src="/resuorces/js/jquery-3.2.1.min.js"></script>
<script>
	// star rating
...
<body>
	...
	<div class="container">
		...
		<button type="button" class="btn btn-primary btn-lg"
			data-toggle="modal" data-target="#myModal">후기등록</button>
				...
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="myModalLabel"
							style="line-height: center;">REVIEW</h4>
					</div>
						...
						<form class="form-group form-horizontal">
							<table class="table">
								<tbody>
									<tr>
										<td>별점</td>
										<td class="form-group"><span class="star-input"> <span
									...
									<tr>
										...
										<td><textarea id="content" name="content"
												class="form-control" rows="8"></textarea></td>
									</tr>
								</tbody>
							</table>
						</form>
